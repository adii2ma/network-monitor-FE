...
export default function Home() {
  ...
  return (
    <main className="max-w-4xl mx-auto pt-8 p-8">
              ...
              <div key={ip} className="border border-gray-200 rounded-lg p-4">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600">Last seen: {formatLastSeen(status.last_seen)}</p>
                    <p className="text-sm text-gray-600">Location: {status.location || "Location not set"}</p>
                  </div>
                  <div className="flex items-center">
                    ...
                    ></span>
                    <span className={`font-medium ${status.online === "true" ? "text-green-600" : "text-red-600"}`}>
